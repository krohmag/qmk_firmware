...
[_BL] = LAYOUT(
  ...
  KC_LCTL,KC_LALT,KC_LGUI,KC_MHEN,        KC_SPC, KC_SPC,                         KC_HENK,KC_RGUI,KC_RALT,MO(_FL),KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT(
  ...
  _______,_______,_______,_______,        _______,_______,                        _______,_______,KC_RALT,MO(_FL),KC_HOME,KC_PGDN,KC_END),
...
[_CL] = LAYOUT(
  ...
  _______,_______,_______,_______,        RGB_MOD,   RGB_MOD,                     _______,_______,KC_RALT,MO(_FL),RGB_HUD,RGB_SAD,RGB_HUI),
};
