...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KEYMAP_ALL(
    ...
    KC_LCTL,  KC_LALT,  KC_LGUI,                      KC_SPC,   KC_SPC,   KC_SPC,                       MO(_FL),  KC_RGUI,  KC_RALT,  KC_LEFT,  KC_DOWN,  KC_RGHT),
  ...
  [_FL] = KEYMAP_ALL(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,                      XXXXXXX,  XXXXXXX,  XXXXXXX,                      MO(_FL),  XXXXXXX,  RESET  ,  KC_HOME,  KC_PGDN,  KC_END),
